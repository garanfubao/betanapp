...
class _TaiXeScreenState extends ConsumerState<TaiXeScreen> {
                  ...
                  child: Row(
                    ...
                    children: [
                      Container(
                        ...
                        height: 6,
                        decoration: BoxDecoration(
                          color: stats['isOnline'] ? AppTheme.primaryColor : AppTheme.textDisabledColor,
  ...
  Widget _buildDetailRow(String label, String value) {
    // Xác định xem có phải giá trị tài chính quan trọng không
    final isFinancialValue = label.contains('Thu nhập') || label.contains('Số dư') || label.contains('Tổng thu nhập');
        ...
        children: [
          ...
          Expanded(
            ...
            child: Text(
              ...
              style: TextStyle(
                fontWeight: FontWeight.w600,
                color: isFinancialValue ? AppTheme.primaryColor : AppTheme.textPrimaryColor,
              ),
            ),
          ),
        ],
