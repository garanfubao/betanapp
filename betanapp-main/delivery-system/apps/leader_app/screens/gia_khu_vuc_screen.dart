      ...
      child: Column(
        ...
        children: [
              ...
              Container(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    ...
                    color: areaPrice.isActive ? AppTheme.primaryColor : AppTheme.textDisabledColor,
                  ),
                ),
              ),
            ],
          ...
          Wrap(
            ...
            children: [
              ...areaPrice.districts.take(3).map((district) => Container(
                padding: const EdgeInsets.symmetric(
                  horizontal: AppTheme.spacingS,
                  vertical: AppTheme.spacingXS,
                ),
              ...
              if (areaPrice.districts.length > 3)
                Container(
                  padding: const EdgeInsets.symmetric(
                    horizontal: AppTheme.spacingS,
                    vertical: AppTheme.spacingXS,
